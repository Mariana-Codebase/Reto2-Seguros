...
1. **Identificación** — Al iniciar, Clara puede reconocer si la persona es afiliada:
...
2. En **Demo interactiva**, el selector *"Perfil de la base de afiliados"* carga
...
3. El flujo también funciona para un **visitante anónimo**: ante *"no sé qué seguro
